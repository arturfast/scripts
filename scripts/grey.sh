...
sed -i 's#themes/.*#themes/grey/theme.lua")#' /home/artur/.config/awesome/rc.lua
sed -i "/Markierung1/c\colors: *grey-colors # Markierung1" ~/.config/alacritty/alacritty.yml
